...
class Bot(Client):
    ...
    async def set_bot_commands_list(self):
        commands = [
            ...
            BotCommand("batch", "Batch mode usage"),
            BotCommand("myplan", "Check your plan"),
            BotCommand("premium", "Premium info"),
            BotCommand("setchat", "Set target chat"),
            BotCommand("adddestination", "Set channel/group destination"),
            BotCommand("removedestination", "Remove destination chat"),
